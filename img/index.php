	...
	<ul class="service_wrap">
		<li class="service_card">
			<a class="service_link" href="bron.php"> 
				<div class="service_img-wrap"> 
					<img class="service_img" src=" png-transparent-computer-icons-icon-design-others.png" alt="Мониторы">
				</div>
		...
		<li class="service_card">
			<a class="service_link" href="ribalka.php"> 
				<div class="service_img-wrap"> 
					<img class="service_img" src=" png-transparent-computer-icons-icon-design-others.png" alt="Компьютеры" >
				</div>
				<div class="service_desc">
					Рыбалка
				</div>
		...
		<li class="service_card">
			<a class="service_link" href="kompl_.php"> 
				<div class="service_img-wrap"> 
					<img class="service_img" src="png-transparent-computer-icons-icon-design-others.png" alt="Комплектующие для ПК">
				</div>
				<div class="service_desc">
					Аренда судна
				</div>
		...
		<li class="service_card">
			<a class="service_link" href="ystr__enter.php"> 
				<div class="service_img-wrap"> 
					<img class="service_img" src=" png-transparent-computer-icons-icon-design-others.png" alt="Устройства ввода">
		 ...
		 <li class="service_card">
			<a class="service_link" href="progr__obes.php"> 
				<div class="service_img-wrap"> 
					<img class="service_img" src=" png-transparent-computer-icons-icon-design-others.png" alt="Программное обеспечение">
		 ...
		 <li class="service_card">
			<a class="service_link" href="ohota.php"> 
				<div class="service_img-wrap"> 
					<img class="service_img" src=" png-transparent-computer-icons-icon-design-others.png" alt="Носители информации">
				</div>
				<div class="service_desc">
					Организация охоты
				</div>
		 ...
		 <li class="service_card">
			<a class="service_link" href="jest__ssd.php"> 
				<div class="service_img-wrap"> 
					<img class="service_img" src=" png-transparent-computer-icons-icon-design-others.png" alt="Жесткие диски и SSD">
				</div>
				<div class="service_desc">
					Услуги егеря
				</div>
