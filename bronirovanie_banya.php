...
<html>
    ...
    <body>
        ...
        <main>
            <form action="bronirovanie_banya.php" method="post">
                <fieldset>
...
$otziv = mysqli_query($link, "INSERT INTO bronirovanie (id, imya, familia, otchestvo, nomer_doma,kol_spal_mest,data_zaselenya,srok,na_chto) VALUES ('', '".$_POST['Imya']."', '".$_POST['familia']."', '".$_POST['Otchestvo']."', ".$_POST['home'].",".$_POST['bed'].",'".$_POST['month'].".".$_POST['day']."',".$_POST['dayscount'].",'banya')");

header('Location: banya.php');
}
