...
<html>
    ...
    <body>
        ...
        <main>
            <form action="bronirovanie_ribalka.php" method="post">
                <fieldset>
                    <legend>Рыбалка</legend>
                    <label>Фамилия</label> 
...
$otziv = mysqli_query($link, "INSERT INTO bronirovanie (id, imya, familia, otchestvo, nomer_doma,kol_spal_mest,data_zaselenya,srok,na_chto) VALUES ('', '".$_POST['Imya']."', '".$_POST['familia']."', '".$_POST['Otchestvo']."',0,0,'".$_POST['month'].".".$_POST['day']."',".$_POST['dayscount'].",'ribalka')");

header('Location: ribalka.php');
}
